...
const Reservation = async () => {
  ...
  const reverseContent = await getReservePageContent(locale);
          ...
          <div className="tst-content-box">
            <div className="container tst-p-60-60">
              <ReservationFormSection
                data={reverseContent?.data?.attributes?.form}
              />
              <div
                id="map"
                className="row mt-5"
              ...
              <ContactInfoSection
                data={reverseContent?.data?.attributes?.contact}
              />
            </div>
          </div>
        </div>
...
async function getReservePageContent(locale) {
  const reverseContent = await strapiApiRequest(
    `reservation-page?locale=${locale}&populate[0]=form&populate[1]=contact&populate[2]=contact.contacts&populate[4]=contact.contacts.icon`,
    undefined,
    undefined
    // {
