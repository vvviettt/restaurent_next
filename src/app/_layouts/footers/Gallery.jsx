  ...
  return (
    <>
            ...
            <div className="tst-footer-gal-item">
              ...
              <a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  setImg(true);
                  setImgValue([{ src: item.image, alt: item.alt }]);
                }}
              >
      ...
      <div className="tst-gallery-nav">
        <Link href={button.link} className="tst-label tst-color tst-anima-link">
          {button.label}
        </Link>
        <div className="tst-fg-nav">
          <div className="tst-slider-btn tst-fg-prev">
            <i className="fas fa-arrow-left"></i>
          </div>
          <div className="tst-slider-btn tst-fg-next">
