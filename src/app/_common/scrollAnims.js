...
export const ScrollAnimation = () => {
  ...
  const animatedMainSliderElements = document.querySelectorAll(
    ".tst-main-title , .tst-main-slider-nav , .tst-main-pagination"
  );
  ...
  if (animatedParallaxElements !== undefined) {
    window.addEventListener("scroll", (e) => {
      animatedParallaxElements.forEach((element) => {
        ...
        element.style.top = window.scrollY * 0.3 + "px";
      });
    });
  }
